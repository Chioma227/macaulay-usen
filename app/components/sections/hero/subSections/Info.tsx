  ...
  return (
    <div>
      <h3 className="text-lightGrey md:text-[40px] text-[25px] leading-[40px] font-bold">
        Hey, <br />
        I&apos;m <span className="text-burgundry">Macaulay</span> <br />A Mobile Developer.
      </h3>
      ...
      <a href="mailto:macaulayubon@gmail.com" className="flex items-center  gap-[10px] mt-[20px]">
        <p className="text-burgundry  font-semibold text-[19px]"> Let&apos;s Talk</p> <MdOutlineMail className="text-burgundry"/>
      </a>
    </div>
  );
};
